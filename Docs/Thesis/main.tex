...
\todo[inline]{Sekcja "Skróty i oznaczenia" nie jest dodawana automatycznie do spisu treści, trzeba ją dodawać ręczenie. Ale przy ręcznym dodawaniu, spis treści nie wskazuje prawidłowo na początek sekcji, tylko na początek strony gzdie ta sekcja się znajduje.}
...
\section{Architektury i pojęcia podstawowe}
