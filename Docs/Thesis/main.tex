...
%\newgeometry{top=0pt, bottom=6pt}
\begin{spacing}{1.5} % 1.5x line spacing
\tableofcontents
\end{spacing}
%\restoregeometry
...
\section{Algorytmy}
\subfile{Sections/MainSections/03-alghorithms}

\section{System operacyjny}
\subfile{Sections/MainSections/04-operating-system}
